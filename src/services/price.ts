// BDX price via CoinGecko (coin id "beldex") — ported from the extension.
// Cached for 60s to stay well under the free-tier rate limit even though the
// wallet screens poll every 15s.
