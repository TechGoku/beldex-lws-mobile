    ...
    >
      <Box sx={{ height: "calc(100vh - 107px)", overflowY: "auto" }}>
        ...
        <Box sx={{ color: theme.palette.text.primary, fontSize: '20px', margin: isMobileMode ? "0" : '40px 40px 25px', }}>
          ...
          <Typography>These Terms of Service and any terms expressly incorporated herein ("Terms") apply to your access to and use of the Beldex hosted account services (our "Services") provided by Beldex International Inc. ("Company," "we," or "us").</Typography>
          ...
          <Typography>
            As described in more detail below, our Services provides in browser software that (a) generates and stores a Beldex account address and the associated view private key, and (b) facilitates the submission of Beldex transaction requests to the Beldex network without requiring you to personally download and install the associated Beldex client software.
          </Typography>
          <Typography sx={{ marginTop: '20px', }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 4.1 Account Address and Private Key. </Typography>
            <Typography component={"span"}>
              &nbsp;When you create an Account, the Services (software in your browser), generate a pair of cryptographic private and public key pairs that you may use to send and receive Beldex via the Beldex network. The view key of the account is stored by the Service, which enables it to determine any transactions that are for your account. The private spend key is never stored or known by the Services, which means that it is cryptographically impossible for us to spend funds on your behalf. The combined public keys generated by the Services serve as your Beldex account address, and may be shared with the Beldex network and with others to complete Beldex transactions. The private key uniquely matches the account address and must be used in connection with the account address to create transactions to send Beldex from that account address. You are solely responsible for maintaining the security of your private key and your Private Login Key. You acknowledge and agree that anybody that has access to your Private Login Key and/or private key pair will be able to access, spend or transfer the Beldex associated with that account address.
            </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  4.2. No Private Login Key Retrieval.</Typography>
            <Typography component={"span"}>
              ...
              <Typography component={"span"} sx={{ marginTop: '20px', fontWeight: 700 }}>
                &nbsp;IF YOU HAVE NOT SEPARATELY STORED A BACKUP OF ANY ACCOUNT ADDRESSES AND PRIVATE LOGIN KEY OR PRIVATE VIEW/SPEND KEY PAIRS MAINTAINED IN YOUR ACCOUNT, YOU ACKNOWLEDGE AND AGREE THAT ANY Beldex YOU HAVE ASSOCIATED WITH SUCH ACCOUNT ADDRESSES WILL BECOME INACCESSIBLE IF YOU DO NOT HAVE YOUR ACCOUNT PRIVATE LOGIN KEY</Typography></Typography> </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 4.3. Transaction Requests.</Typography>
            <Typography component={"span"}>
              &nbsp;All proposed Beldex transactions must be confirmed and recorded in the Beldex public ledger via the Beldex distributed consensus network ("Verification Network"), which is not owned, controlled or operated by us. The Services help you submit your Beldex transaction request for confirmation to the Verification Network. However, the Beldex network, including the Verification Network, is operated by a decentralized network of independent third parties. We have no control over the Beldex network, including the Verification Network, and therefore cannot and do not ensure that any transaction request you submit via the Services will be confirmed via the Verification Network. You acknowledge and agree that the transaction requests you submit via the Services may not be completed, or may be substantially delayed, by the Verification Network. When you complete a transaction request via the Services, you authorize us to submit your transaction request to the Verification Network in accordance with the instructions you provide via the Services.                </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  4.4. No Storage or Transmission of Beldex.</Typography>
            <Typography component={"span"}>
              &nbsp; Beldex (BDX) are an intangible asset, they exist only by virtue of the ownership record maintained in the Beldex network. The Services do not store, send or receive Beldex. Any transfer of title in Beldex occurs within the decentralized Beldex network and not within the Services.                </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  4.5. Relationship.</Typography>
            <Typography component={"span"}>
              &nbsp;Company is an independent contractor for all purposes, and is not your agent or trustee.                </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  4.6. Accuracy of Information. </Typography>
            <Typography component={"span"}>
              You represent and warrant that any information you provide via the Services is accurate and complete. You acknowledge and agree that the Company is not responsible for any errors or omissions that you make in connection with any Beldex transaction initiated via the Services. For instance, if you mistype an account address or otherwise provide incorrect information in connection with any transaction request to send Beldex via the Service, the Beldex will be sent to whatever account address or information you provide. We strongly encourage you to review your transaction request details carefully before completing any transaction requests via the Services.                </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  4.7. No Cancellations or Modifications.</Typography>
            <Typography component={"span"}>
              &nbsp; Once a transaction request has been submitted to the Beldex Verification Network via the Services, the Verification Network will automatically complete or reject the request and you will not be able to cancel or otherwise modify your transaction request. Company has no control over the Beldex Verification Network and does not have the ability to facilitate any cancellation or modification requests. As a result, all transaction requests initiated via the Services are irreversible.
            </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 4.8. Taxes.</Typography>
            <Typography component={"span"}>
              &nbsp;It is your responsibility to determine what, if any, taxes apply to the transactions you complete via the Services, and it is your responsibility to report and remit the correct tax to the appropriate tax authority. You agree that the Company is not responsible for determining whether taxes apply to your Beldex transactions or for collecting, reporting, withholding or remitting any taxes arising from any Beldex transactions.                 </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700, color: theme.palette.text.primary }}>
            5. Fees
          </Typography>
          <Typography sx={{ fontWeight: 700 }}>
            <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  5.1. Company Fees.</Typography>
            <Typography component={"span"}>
              &nbsp; Access to the account is free, but the Company may charge fees for additional Services. Specifically, and at a minimum, the Company can and does charge a fee for every transaction that is sent. Any applicable fees will be displayed in each Service.                 </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700, color: theme.palette.text.primary }}>
            5.2. Validator Fees.
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
            ...
            <Typography component={"span"}>
              &nbsp; The Beldex Verification Network (described above) is operated by a network of computers that have installed the Beldex network software. The individuals who operate those computers, called "validators," voluntarily participate in the Verification Network confirmation process. Beldex validators compile a list of pending Beldex transactions, called "blocks," verify that each transaction in the block is valid and does not involve an attempt to re-spend Beldex, and solve a mathematical algorithm to confirm that the block should be added to the public ledger of confirmed blocks, called the "blockchain." Beldex validation is based on an on-chain consensus mechanism. The validator to verify the transactions in a block and solve the associated algorithms receive an amount of Beldex as a reward, which is generated automatically via the Beldex network. Since validators verify Beldex transactions on a voluntary basis, block rewards provide an incentive to the validators to add a proposed transaction to the next block for confirmation via the Verification Network.                 </Typography>
          </Typography>
          <Typography sx={{ marginTop: '20px' }}>
            You acknowledge and agree that the Company does not receive any Miners Fees in connection with providing the Services, and is not responsible for the speed at which your transactions may be verified by miners.                 </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700, color: theme.palette.text.primary }}>
            6. Discontinuance of Services
          </Typography>
          <Typography>
            We may, in our sole discretion and without liability to you, with or without prior notice and at any time, modify or discontinue, temporarily or permanently, any portion of our Services. You are solely responsible for storing, outside of the Services, a backup of any account address and private key pair that you maintain in your Account. If you do not maintain a backup of your Account data outside of the Services, you will be unable to access Beldex associated with any account address maintained in your Account in the event that we discontinue the Services.
          </Typography>
          <Typography sx={{ marginTop: '20px', fontWeight: 700, color: theme.palette.text.primary }}>
          ...
          <Typography sx={{ marginTop: '20px', }}>
            ...
            <Typography component={'ul'} sx={{ marginTop: '20px' }}>
              <Typography component={'li'}>
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 17.1. Entire Agreement;  </Typography>
                <Typography component={'span'}>
                  &nbsp; Order of Precedence. These Terms contain the entire agreement, and supersede all prior and contemporaneous understandings between the parties regarding the Services. These Terms do not alter the terms or conditions of any other electronic or written agreement you may have with Company for the Services or for any other Company product or service or otherwise. In the event of any conflict between these Terms and any other agreement you may have with Company, the terms of that other agreement will control only if these Terms are specifically identified and declared to be overridden by such other agreement.
                </Typography>
              </Typography>
              <Typography component={'li'} >
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  17.2. Amendment.</Typography>
                <Typography component={'span'}>
              ...
              <Typography component={'li'} >
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}>  17.3. Waiver.</Typography>
                <Typography component={'span'}>
                  &nbsp;Our failure or delay in exercising any right, power or privilege under these Terms will not operate as a waiver thereof.
                </Typography>
              </Typography>
              <Typography component={'li'}>
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 17.4. Severability.</Typography>
                <Typography component={'span'}>
              ...
              <Typography component={'li'} >
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 17.5. Force Majeure Events.</Typography>
                <Typography component={'span'}>
              ...
              <Typography component={'li'} >
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 17.6. Assignment.</Typography>
                <Typography component={'span'}>
                  &nbsp;You may not assign or transfer any of your rights or obligations under these Terms without prior written consent from the Company, including by operation of law or in connection with any change of control. Company may assign or transfer any or all of its rights under these Terms, in whole or in part, without obtaining your consent or approval.
                </Typography>
              </Typography>
              <Typography component={'li'} >
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 17.7. Headings.</Typography>
                <Typography component={'span'}>
                  &nbsp;Headings of sections are for convenience only and will not be used to limit or construe such sections.
                </Typography>
              </Typography>
              <Typography component={'li'} >
                <Typography component={"span"} sx={{ color: theme.palette.text.primary, fontWeight: 700 }}> 17.8. Survival.</Typography>
                <Typography component={'span'}>
