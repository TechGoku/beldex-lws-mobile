...
exports.ExchangeServiceProviderCard = void 0;
...
var ExchangeServiceProviderCard = /*#__PURE__*/function (_LitElement) {
  (0, _inherits2["default"])(ExchangeServiceProviderCard, _LitElement);

  var _super = _createSuper(ExchangeServiceProviderCard);

  function ExchangeServiceProviderCard() {
    var _this;

    (0, _classCallCheck2["default"])(this, ExchangeServiceProviderCard);
    _this = _super.call(this);
    _this.service = {};
    _this.context = {};
    _this.destinationView = "";
    return _this;
  }

  (0, _createClass2["default"])(ExchangeServiceProviderCard, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      (0, _get2["default"])((0, _getPrototypeOf2["default"])(ExchangeServiceProviderCard.prototype), "connectedCallback", this).call(this); // this.addEventListener('touchstart', () => {
      // });
    ...
    value: function disconnectedCallback() {
      (0, _get2["default"])((0, _getPrototypeOf2["default"])(ExchangeServiceProviderCard.prototype), "disconnectedCallback", this).call(this);
    }
  }, {
    ...
    value: function handleClickEvent(event) {
      ...
      var providerCardClickedEvent = new CustomEvent("provider-card-clicked", options);
      this.dispatchEvent(providerCardClickedEvent, options); // console.log("Dispatch click event from provider card:", event);
    }
  }, {
    key: "openExternal",
    ...
    value: function createRenderRoot() {
      ...
      var root = (0, _get2["default"])((0, _getPrototypeOf2["default"])(ExchangeServiceProviderCard.prototype), "createRenderRoot", this).call(this); // We still need to flesh this out for clicks

      root.addEventListener('click', function (event) {
        var options = {
          detail: _this2.service,
          bubbles: true,
          composed: true
        };
        var providerCardClickedEvent = new CustomEvent("provider-card-clicked", options);

        _this2.dispatchEvent(providerCardClickedEvent, options);
      });
    ...
    value: function render() {
      return (0, _lit.html)(_templateObject || (_templateObject = (0, _taggedTemplateLiteral2["default"])([" \n        <div class=\"provider-card\" @click=", " ontouchstart=", ">\n             <div class=\"utility\">\n                 <div class=\"", "-logo provider-logo\">\n\n                 </div>\n             </div>    \n             <div class=\"title-label\">", "</div>\n             <div class=\"description-label\">", "</div>\n         </div>"])), this.handleClickEvent, this.handleClickEvent, this.service.service_provider, this.service.title, this.service.description); // return html`
  ...
  return ExchangeServiceProviderCard;
}(_lit.LitElement);
/*
...
exports.ExchangeServiceProviderCard = ExchangeServiceProviderCard;
